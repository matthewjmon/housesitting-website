    ...
    >
      <nav className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        >
          ...
          <span className={`font-heading font-bold text-base leading-tight transition-colors duration-300 ${
          ...
          {NAV_LINKS.map(link => (
            <li key={link.label}>
              <a
                ...
                className={`text-sm font-medium transition-colors duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 rounded ${
                  scrolled
        ...
        <a
          ...
          className="hidden md:inline-flex btn-primary text-sm px-5 py-2.5 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-primary-500"
        >
          Book Now
        </a>
        ...
        {/* Mobile hamburger */}
        <button
          className={`md:hidden p-2 rounded-lg transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 ${
            scrolled
