    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-12 grid grid-cols-1 sm:grid-cols-3 gap-10">
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              <span
                className="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-primary-600 text-white text-sm flex-shrink-0"
                aria-hidden="true"
              >
                🏠
              </span>
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Trusted, reliable house and pet sitting in Gonubie, East London.
              Available all week.
            </p>
          </div>
        ...
        <div className="border-t border-gray-800 py-5 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-gray-500">
          <span>
            © {new Date().getFullYear()} Gonubie House Sitting. All rights
            reserved.
          </span>
